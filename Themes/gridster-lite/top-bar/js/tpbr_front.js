jQuery(document).ready(function() {
    ...
    if (status == 'active') {
        if (fixed == 'fixed'){
            jQuery('<div style="height:44px; visibility:hidden;"></div><div id="tpbr_topbar" style="' + fixed_result + ' background:' + tbcolor + '; padding:4px 20px 3px;"><div id="tpbr_box" style="line-height:40px; font-size:15px; font-family: Helvetica, Arial, sans-serif; text-align:justify; width:100%; color:white; font-weight:300;">' + btn_result + '<img src="http://threejs-sadan.co.nf/kpk-test/wp-content/uploads/2017/09/cropped-cropped-kpk_ny_uten_undertekst_low-e1504279467720.png" alt="" width="60" height="30" class="alignnone size-full wp-image-168" style="margin: 10px 10px -10px;">' + '</div></div>').prependTo('body');
        } else {
            jQuery('<div id="tpbr_topbar" style="position:relative; z-index:999999999; ' + fixed_result + ' background:' + tbcolor + '; padding:4px 20px 3px;"><div id="tpbr_box" style="line-height:40px; text-align:justify; width:100%; color:white; font-size:15px; font-family: Helvetica, Arial, sans-serif; font-weight:300;">' + btn_result + '<img src="http://threejs-sadan.co.nf/kpk-test/wp-content/uploads/2017/09/cropped-cropped-kpk_ny_uten_undertekst_low-e1504279467720.png" alt="" width="60" height="30" class="alignnone size-full wp-image-168" style="margin: 10px 10px -10px;">' + '</div></div>').prependTo('body');
        }
    }
